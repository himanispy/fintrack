    ...
    <div style={S.root}>
      ...
      <div style={S.card}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          {/* FIXED: Split into two divs, no <br/> inside gradient text */}
          <div style={{
            fontSize: 26, fontWeight: 800, lineHeight: 1.2,
            background: 'linear-gradient(135deg,#7C6EF5,#FF6B6B)',
        ...
        {error && (
          <p style={{ color: '#FF6B6B', fontSize: 12, marginBottom: 16, textAlign: 'center' }}>
            {error}
          </p>
        )}
        ...
        <p style={{ textAlign: 'center', color: '#555', fontSize: 13, marginTop: 16 }}>
          No account?{' '}
          <span style={{ color: '#7C6EF5', cursor: 'pointer' }} onClick={onSwitch}>
            Register
          </span>
        </p>
      </div>
